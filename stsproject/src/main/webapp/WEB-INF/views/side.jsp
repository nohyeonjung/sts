...
<a href="logOut.do" style="text-decoration: none; text-align:center; color:#000000;">로그아웃</a>
</c:if>
<c:if test="${id eq null}">
<a href="list.do" style="text-decoration: none; text-align:center; color:#000000;">게시판</a><br>
<a href="login.do" style="text-decoration: none; text-align:center; color:#000000;">로그인</a>
</c:if>
	<%--
